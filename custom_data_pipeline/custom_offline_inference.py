...
CKPT_PATH = "data/outputs/2026.05.28/05.05.32_train_diffusion_unet_timm_umi/checkpoints/latest.ckpt"
DATASET_PATH = "custom_data_pipeline/old_dataset/dataset.zarr.zip"
OUTPUT_DIR = "custom_data_pipeline/old_dataset"
DEVICE = "cuda:0"
BATCH_SIZE = 6
NUM_WORKERS = 0
